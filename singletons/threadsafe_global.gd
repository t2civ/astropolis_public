...
# settings
var total_biodiversity_pool := 32860.0 * IVUnits.SPP  ## Global biodiversity pool (species count units).
var total_information_pool := 1.8e22 * IVUnits.BIT  ## Global information pool (bit units).
